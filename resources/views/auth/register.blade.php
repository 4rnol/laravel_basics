                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fbId" type="text" class="form-control @error('fbId') is-invalid @enderror" name="fbId" value="{{ old('fbId') }}" required autocomplete="fbId" >
                                @error('fbId')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="userRole" type="text" class="form-control @error('userRole') is-invalid @enderror" name="userRole" value="{{ old('userRole') }}" required autocomplete="userRole" >
                                @error('userRole')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
